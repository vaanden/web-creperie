...
public class CartCreateRequest  implements java.io.Serializable {
    ...
    private com.amazon.webservices.AWSECommerceService.CartCreateRequestItemsItem[] items;
    ...
    public CartCreateRequest(
           ...
           com.amazon.webservices.AWSECommerceService.CartCreateRequestItemsItem[] items,
     ...
     * @return items
     */
    public com.amazon.webservices.AWSECommerceService.CartCreateRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.webservices.AWSECommerceService.CartCreateRequestItemsItem[] items) {
        this.items = items;
    }
