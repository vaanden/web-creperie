...
public class CartModifyRequest  implements java.io.Serializable {
    ...
    private com.amazon.webservices.AWSECommerceService.CartModifyRequestItemsItem[] items;
    ...
    public CartModifyRequest(
           ...
           com.amazon.webservices.AWSECommerceService.CartModifyRequestItemsItem[] items,
     ...
     * @return items
     */
    public com.amazon.webservices.AWSECommerceService.CartModifyRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.webservices.AWSECommerceService.CartModifyRequestItemsItem[] items) {
        this.items = items;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "CartModifyRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", ">>CartModifyRequest>Items>Item"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
