...
public class ItemAttributesItemDimensions  implements java.io.Serializable {
    private com.amazon.webservices.AWSECommerceService.DecimalWithUnits height;

    private com.amazon.webservices.AWSECommerceService.DecimalWithUnits length;

    private com.amazon.webservices.AWSECommerceService.DecimalWithUnits weight;

    private com.amazon.webservices.AWSECommerceService.DecimalWithUnits width;

    public ItemAttributesItemDimensions() {
    }

    public ItemAttributesItemDimensions(
           com.amazon.webservices.AWSECommerceService.DecimalWithUnits height,
           com.amazon.webservices.AWSECommerceService.DecimalWithUnits length,
           com.amazon.webservices.AWSECommerceService.DecimalWithUnits weight,
           com.amazon.webservices.AWSECommerceService.DecimalWithUnits width) {
           this.height = height;
           this.length = length;
           this.weight = weight;
           this.width = width;
     ...
     * @return height
     */
    public com.amazon.webservices.AWSECommerceService.DecimalWithUnits getHeight() {
        return height;
    }
     ...
     * @param height
     */
    public void setHeight(com.amazon.webservices.AWSECommerceService.DecimalWithUnits height) {
        this.height = height;
    }
     ...
     * @return length
     */
    public com.amazon.webservices.AWSECommerceService.DecimalWithUnits getLength() {
        return length;
    }
     ...
     * @param length
     */
    public void setLength(com.amazon.webservices.AWSECommerceService.DecimalWithUnits length) {
        this.length = length;
    }
     ...
     * @return weight
     */
    public com.amazon.webservices.AWSECommerceService.DecimalWithUnits getWeight() {
        return weight;
    }
     ...
     * @param weight
     */
    public void setWeight(com.amazon.webservices.AWSECommerceService.DecimalWithUnits weight) {
        this.weight = weight;
    }
     ...
     * @return width
     */
    public com.amazon.webservices.AWSECommerceService.DecimalWithUnits getWidth() {
        return width;
    }
     ...
     * @param width
     */
    public void setWidth(com.amazon.webservices.AWSECommerceService.DecimalWithUnits width) {
        this.width = width;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", ">>ItemAttributes>ItemDimensions"));
