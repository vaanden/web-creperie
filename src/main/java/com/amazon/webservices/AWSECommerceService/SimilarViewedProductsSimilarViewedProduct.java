...
public class SimilarViewedProductsSimilarViewedProduct  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", ">>SimilarViewedProducts>SimilarViewedProduct"));
